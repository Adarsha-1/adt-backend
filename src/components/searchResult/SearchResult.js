    ...
    useEffect(() => {
        ...
        const getRecipe = async (query) => {
            try {
                ...
                let url = "http://3.18.110.132:8086/playmate/recipe/search?name=" + query
        ...
        const getRecipeBySteps = async (query) => {
          try {
              console.log("query is:", query)
              let url = "http://3.18.110.132:8086/playmate/recipe/search/steps?stepsCount=" + query
              const response = await axios.get(url);
              console.log(response.ok);
              //const response = await searchRecipes(query);
      ...
      const getRandom = async () => {
        try {
            let url = "http://3.18.110.132:8086/playmate/recipe/search/random"
            const response = await axios.get(url);
            console.log(response.ok);
            //const response = await searchRecipes(query);
