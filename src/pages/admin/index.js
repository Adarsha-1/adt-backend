...
function Admin() {
  ...
  useEffect(() => {
    async function fetchRecipes() {
      try {
        const result = await axios.get('http://3.18.110.132:8086/playmate/recipe/unapproved');
  ...
  async function approveRecipe(recipeId) {
    try {
      var url = 'http://3.18.110.132:8086/playmate/recipe/approve?recipeId=' + recipeId 
