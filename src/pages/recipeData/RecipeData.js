...
const RecipeData = () => {
  ...
  const handleFavourite = async() => {
    ...
    if (activeFavorite) {
      ...
      try {
        ...
        let url = "http://3.18.110.132:8086/playmate/user/remove"
      ...
      try {
        ...
        let url = "http://3.18.110.132:8086/playmate/user/addFavorite"
        const response = await axios.post(url, userDetails)
  ...
  const handleLike = async() => {
    if (active) {
      ...
      try {
        ...
        let url = "http://3.18.110.132:8086/playmate/recipe/removeLike";
      ...
      try {
        ...
        let url = "http://3.18.110.132:8086/playmate/recipe/addLike";
        const response = await axios.post(url, cmt);
        //const { meals } = await response.json();
        console.log("response is: ", response);
      } catch (err) {
  ...
  const getMealDetails = async (query) => {
    ...
    try {
      let url = "http://3.18.110.132:8086/playmate/recipe/dish?id=" + query;
